...
class ImageCamera(object):
    ...
    def get_frame(self):
        ...
        if self.count:
            ...
            image = utils.draw_bbox(original_image, pred_bbox, self.object_count, self.is_time_count, self.info, counted_classes, allowed_classes=allowed_classes, read_plate = self.plate)
        else:
